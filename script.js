...
class App {
    ...
    _newWorkout(e) {
        ...
        // If workout activity running, create runnign object
        if (type === 'running') {
            const cadence = +inputCadence.value;
            if (!validInput(distance, duration, cadence) || !allPostive(distance, duration, cadence)) {
                return alert('Input number sould be positive');
            }
        ...
        // Render workout on map as render
